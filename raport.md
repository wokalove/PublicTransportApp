...
## **Założenia**
Ogólnym założeniem mojego projektu było wyszukiwanie połączeń tramwajowych i autobusowych na podstawie bazy MPK Kraków z 2012 roku (_niestety bardziej aktualna wersja nie była dostępna_) oraz policzenie kosztów podróży.
